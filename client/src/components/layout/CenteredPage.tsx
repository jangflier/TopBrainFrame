...
export const CenteredPage: FC<CenteredPageProps> = ({ children, className = "", title = "" }) => {
	...
	return (
		<main>
			<div
				className={`full-viewport row g-0 d-flex justify-content-center align-items-center overflow-auto`}>
				<div className={`col-xxl-3 col-xl-5 col-lg-6 col-md-8 col-sm-9 p-2 ${className}`}>
					{children}
				</div>
			</div>
		</main>
